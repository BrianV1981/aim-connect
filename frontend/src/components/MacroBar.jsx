...
export default function MacroBar({ 
  macroLibrary, onSendCommand, onToggleMacroPin, onSaveMacro, onDeleteMacro,
  showMacroLibrary, setShowMacroLibrary
}) {
        ...
        <div className="macro-group">
          {macroLibrary.filter(m => m.isPinned).map((macro) => (
            <button 
              ...
              onContextMenu={(e) => { e.preventDefault(); onToggleMacroPin(macro.id); }}
            >
